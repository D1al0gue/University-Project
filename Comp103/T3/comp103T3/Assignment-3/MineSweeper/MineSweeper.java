...
public class MineSweeper {
    ...
    public void exposeSquareAt(int row, int col){
        ...
        if(!squares[row][col].isExposed()){
            ...
            //got this in google, for the recursion part (finding the rows and cols, aka the for loop)
    ...
    public static void main(String[] arguments){
        ...
        UI.println("""
         mark/unmark a box
         expose a single box
         using recursion to check for adjacent mines and clearing any boxes that has 0 mines
