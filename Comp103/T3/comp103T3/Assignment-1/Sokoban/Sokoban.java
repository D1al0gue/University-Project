...
public class Sokoban {
    ...
    private Stack<Position> undoPositions = new Stack<>();
    ...
    public void pull(String direction) {
        /*# YOUR CODE HERE */
       Position boxP = workerPos.next(opposite(direction));

       cells[boxP.row][boxP.col].removeBox();
       cells[workerPos.row][workerPos.col].addBox();

       drawCell(boxP);
       drawCell(workerPos);

        workerPos = workerPos.next(direction);
        workerDir = opposite(direction);
        drawWorker();
    ...
    public void setupGUI(){
        ...
        UI.addButton("pull",            () -> pull(opposite(workerDir)));
